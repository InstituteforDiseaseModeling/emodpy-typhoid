...
def run_test():
    ...
    cov = [0.75]
    sweep_list = []
    Typhoid_Acute_Infectiousness = [16000]
    Typhoid_Exposure_Lambda = [10]
    Typhoid_Environmental_Exposure_Rate = [0.54]
    Typhoid_Contact_Exposure_Rate = [1]
    min_value = 0.05
    max_value = 0.5
    step = 0.05
    ...
    experiment = Experiment.from_template(ts, name="test_vax_sweep_configs_Sindh_case3")
